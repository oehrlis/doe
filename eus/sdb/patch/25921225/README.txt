...
ORACLE DATABASE Patch for Bug# 25921225 for Linux-x86-64 Platforms
...
Released: Sat Sep  5 00:25:40 2020
  
This document describes how you can install the ORACLE DATABASE overlay patch for bug#  25921225 on your Oracle Database 12c Release 12.1.0.2.200714DBPSU
...
3.      Ensure that you have OPatch 12c Release 12.1.0.1.7 or higher. Oracle recommends that you use the latest version available for  12c Release 12.1.0.1.7. 
	
	Note:
	If you do not have OPatch 12c Release 12.1.0.1.7 or the latest version available for 12c Release 12.1.0.1.7, then download it from patch# 6880880 for  12.1.0.1.7.
...
7.	(Only for Installation) Maintain a location for storing the contents of the patch ZIP file. In the rest of the document, this location (absolute path) is referred to as <PATCH_TOP_DIR>. Extract the contents of the patch ZIP file to the location (PATCH_TOP_DIR) you have created above. To do so, run the following command:
	$ unzip -d <PATCH_TOP_DIR>  p25921225_12102200714_Linux-x86-64.zip 


8.	(Only for Installation) Determine whether any currently installed interim patches conflict with this patch 25921225 as shown below:
	$ cd <PATCH_TOP_DIR>/25921225
	$ opatch prereq CheckConflictAgainstOHWithDetail -ph ./
	
	The report will indicate the patches that conflict with this patch and the patches for which the current 25921225 is a superset.
...
The following are the bugs fixed by this patch:
  25921225: NEED SUPPORT DIRECTORY USERS LOGON TO DATABASE WITH 12C VERIFIER
