...
# - create mappings ----------------------------------------------------
echo " List subtree mapping for ${PDB}_${ORACLE_SID} on ou=People,${BASEDN} to EUS_USERS"
...
echo " Create entry mapping for ${PDB}_${ORACLE_SID} on cn=Ben King,ou=Senior Management,ou=People,${BASEDN} to KING"
