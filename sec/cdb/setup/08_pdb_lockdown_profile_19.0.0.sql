...
-- Test 01.02.2021 MBg
ALTER LOCKDOWN PROFILE sc_default ENABLE STATEMENT=('ALTER DATABASE') CLAUSE=('RECOVER AUTOMATIC DATABASE');
ALTER LOCKDOWN PROFILE sc_default ENABLE STATEMENT=('ALTER PLUGGABLE DATABASE') CLAUSE=('RECOVER AUTOMATIC DATABASE');
...
ALTER LOCKDOWN PROFILE sc_restricted ENABLE OPTION = ('TRANSPARENT DATA ENCRYPTION');
