...
ALTER LOCKDOWN PROFILE sc_default DISABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('CLOSE');
ALTER LOCKDOWN PROFILE sc_default ENABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('OPEN');
---------------------------------------------------------------------------
...
ALTER LOCKDOWN PROFILE sc_trace ENABLE OPTION ALL EXCEPT = ('DATABASE QUEUING');
ALTER LOCKDOWN PROFILE sc_trace ENABLE OPTION ALL EXCEPT = ('DATABASE QUEUING');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('CONNECTIONS');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('CTX_LOGGING');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('NETWORK_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('OS_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('JAVA_RUNTIME');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('JAVA');
ALTER LOCKDOWN PROFILE sc_trace DISABLE FEATURE = ('JAVA_OS_ACCESS');
---------------------------------------------------------------------------
-- Enable simple OS access
ALTER LOCKDOWN PROFILE sc_trace ENABLE FEATURE = ('COMMON_SCHEMA_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace ENABLE FEATURE = ('AWR_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace ENABLE FEATURE = ('LOB_FILE_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace ENABLE FEATURE = ('TRACE_VIEW_ACCESS');
ALTER LOCKDOWN PROFILE sc_trace ENABLE FEATURE = ('UTL_FILE');
---------------------------------------------------------------------------
-- Restrict ALTER DATABASE statement
ALTER LOCKDOWN PROFILE sc_trace DISABLE STATEMENT = ('ALTER DATABASE');
ALTER LOCKDOWN PROFILE sc_trace DISABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('CLOSE');
ALTER LOCKDOWN PROFILE sc_trace ENABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('OPEN');
---------------------------------------------------------------------------
-- disable ALTER SYSTEM in general
ALTER LOCKDOWN PROFILE sc_trace DISABLE STATEMENT = ('ALTER SYSTEM');
ALTER LOCKDOWN PROFILE sc_trace ENABLE STATEMENT = ('ALTER SYSTEM') CLAUSE = ('SET') OPTION = ('OPEN_CURSORS') ;
PAUSE
---------------------------------------------------------------------------
...
ALTER LOCKDOWN PROFILE sc_jvm ENABLE OPTION ALL EXCEPT = ('DATABASE QUEUING');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE OPTION ALL EXCEPT = ('DATABASE QUEUING');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('CONNECTIONS');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('CTX_LOGGING');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('NETWORK_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('OS_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('JAVA_RUNTIME');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('JAVA');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE FEATURE = ('JAVA_OS_ACCESS');
---------------------------------------------------------------------------
-- Enable simple OS access
ALTER LOCKDOWN PROFILE sc_jvm ENABLE FEATURE = ('COMMON_SCHEMA_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE FEATURE = ('AWR_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE FEATURE = ('LOB_FILE_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE FEATURE = ('TRACE_VIEW_ACCESS');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE FEATURE = ('UTL_FILE');
---------------------------------------------------------------------------
-- Restrict ALTER DATABASE statement
ALTER LOCKDOWN PROFILE sc_jvm DISABLE STATEMENT = ('ALTER DATABASE');
ALTER LOCKDOWN PROFILE sc_jvm DISABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('CLOSE');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE STATEMENT = ('ALTER DATABASE') CLAUSE = ('OPEN');
---------------------------------------------------------------------------
-- disable ALTER SYSTEM in general
ALTER LOCKDOWN PROFILE sc_jvm DISABLE STATEMENT = ('ALTER SYSTEM');
ALTER LOCKDOWN PROFILE sc_jvm ENABLE STATEMENT = ('ALTER SYSTEM') CLAUSE = ('SET') OPTION = ('OPEN_CURSORS') ;
PAUSE
---------------------------------------------------------------------------
